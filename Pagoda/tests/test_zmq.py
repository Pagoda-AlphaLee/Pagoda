from src.pagoda.zmqclass import ZmqManager
import logging
import zmq
from typing import Optional, List
from src.pagoda.zmqreq import ZmqReqClient
from src.pagoda.zmqsub import ZmqSub
# 配置日志
logging.basicConfig(
    level=logging.INFO,
...
if __name__ == '__main__':
    ...
    try:
        ...
        # 测试发送消息
        test_message = "<Uid=Test.Message.0.0><Receiver=Dome><Content=HelloWorld><MaxTime=60>"
